...
pub const WORKER_NAMES: [&str; 106] = [
    ...
    "Hikari", "Tairitsu", "Kou", "Kethe", "Stella", "Ilith", "Eto", "Luna", "Shirabe", "Ayu", "Seine", "Saya", "Kanae", "Sia", "Tenniel", "Mir", "Lagrange", "Nami", "Shirahime", "Vita", "Linka", "Amane", "Lethe", "Maya", "Insight", "Compassion", "Nonoka", "Yuno", "Helena", // arcaea
    "Sapphire", "Fisica", "Trin", "Yume", "Chuni", "Haruna", "Nono", "Regulus", "Mia", "Areus", "Seele", "Isabelle", "Lily", "Marija", "Saki", "Setsuna", "Shama", "Milk", "Shikoku", "Mika", "Mithra", "Toa", "Luin", "Ilot", "Hoppe", "Chinatsu", "Tsumugi", "Nai", "Selene", "Salt", "Acid", "Sui", // arcaea collab
...
fn unique_names() {
    ...
    pub const REGEX: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"^[a-zA-Z0-9]+$").expect("could not compile regex"));
