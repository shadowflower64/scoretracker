...
impl MatchDetails for RB4MatchDetails {
...
#[derive(Debug, Clone, Deserialize, Serialize, JsonSchema)]
pub struct RB4PerformanceDetails {
    /// Played instrument.
...
#[typetag::serde(name = "rb4")]
impl PerformanceDetails for RB4PerformanceDetails {
    fn sorting_key(&self) -> f64 {
        self.score as f64
    }
...
impl Game for RockBand4 {
    ...
    fn create_match_and_performance_from_spreadsheet_record(&self, record: &Record, _ctx: &mut Context) -> ParseMatchRecordResult {
        ...
        let match_data = RB4MatchDetails {
            mode: Mode::Quickplay,
            game_version: None,
        };
        let performance_data = RB4PerformanceDetails {
            instrument,
    ...
    game_impl!(RB4MatchDetails, RB4PerformanceDetails);
}

register_game!(RockBand4);
