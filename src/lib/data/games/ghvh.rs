...
pub struct GuitarHeroVanHalen;

#[typetag::serde(name = "ghvh")]
impl Game for GuitarHeroVanHalen {
    ...
    game_impl!(GHVHMatchDetails, GHVHPerformanceDetails);
}
