...
pub struct PJDMegamixPlusMatchDetails {
...
impl MatchDetails for PJDMegamixPlusMatchDetails {
...
#[derive(Debug, Clone, Deserialize, Serialize, JsonSchema)]
pub struct PJDMegamixPlusPerformanceDetails {
...
#[typetag::serde(name = "pjd_megamix_plus")]
impl PerformanceDetails for PJDMegamixPlusPerformanceDetails {
    fn sorting_key(&self) -> f64 {
        self.score as f64
    }
