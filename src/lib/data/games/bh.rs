...
pub struct BandHeroMatchDetails {
...
impl MatchDetails for BandHeroMatchDetails {
...
#[derive(Debug, Clone, Deserialize, Serialize, JsonSchema)]
pub struct BandHeroPerformanceDetails {
    /// Played instrument.
...
#[typetag::serde(name = "bh")]
impl PerformanceDetails for BandHeroPerformanceDetails {
    fn sorting_key(&self) -> f64 {
        self.score as f64
    }
...
impl Game for BandHero {
    ...
    fn create_match_and_performance_from_spreadsheet_record(&self, record: &Record, _ctx: &mut Context) -> ParseMatchRecordResult {
        ...
        let match_data = BandHeroMatchDetails {
            mode: Mode::UnknownSingle,
            game_version: None,
        };
        let performance_data = BandHeroPerformanceDetails {
