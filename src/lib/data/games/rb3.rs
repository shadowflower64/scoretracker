...
impl MatchDetails for RB3MatchDetails {
...
#[derive(Debug, Clone, Deserialize, Serialize, JsonSchema)]
pub struct RB3PerformanceDetails {
    /// Played instrument.
...
#[typetag::serde(name = "rb3")]
impl PerformanceDetails for RB3PerformanceDetails {
    fn sorting_key(&self) -> f64 {
        self.score as f64
    }
...
impl Game for RockBand3 {
    ...
    fn create_match_and_performance_from_spreadsheet_record(&self, record: &Record, _ctx: &mut Context) -> ParseMatchRecordResult {
        ...
        let match_data = RB3MatchDetails {
            mode: Mode::Quickplay,
            game_version: None,
        };
        let performance_data = RB3PerformanceDetails {
            instrument,
