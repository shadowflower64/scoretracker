...
impl MatchDetails for ArcaeaMatchDetails {
...
#[derive(Debug, Clone, Deserialize, Serialize, JsonSchema)]
pub struct ArcaeaPerformanceDetails {
...
impl ArcaeaPerformanceDetails {}

#[typetag::serde(name = "arcaea")]
impl PerformanceDetails for ArcaeaPerformanceDetails {
    fn sorting_key(&self) -> f64 {
        self.score as f64
    }
...
impl Game for Arcaea {
    ...
    fn create_match_and_performance_from_spreadsheet_record(&self, record: &Record, _ctx: &mut Context) -> ParseMatchRecordResult {
        let match_data = ArcaeaMatchDetails { game_version: None };
        let performance_data = ArcaeaPerformanceDetails {
