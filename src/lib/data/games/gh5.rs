//! Data structures for Guitar Hero 5.
//!
...
pub struct GuitarHero5;

#[typetag::serde(name = "gh5")]
impl Game for GuitarHero5 {
    ...
    game_impl!(GH5MatchDetails, GH5PerformanceDetails);
}

register_game!(GuitarHero5);
