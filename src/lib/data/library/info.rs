...
/// The presence of the `library_info.toml` file in the directory indicates that the directory is hosting a library repository.
#[derive(Debug, Clone, Deserialize, Serialize, PartialEq, Eq)]
pub struct LibraryInfo {
    /// Domain name for this library.
    ///
    /// This name is a unique identifier for this library.
...
impl TomlConfig for LibraryInfo {
    const STANDARD_FILENAME: &str = "library_info.toml";
}
