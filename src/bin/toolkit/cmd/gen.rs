...
pub fn gen_all() -> Result<(), CmdError> {
    gen_json_schema()?;
    gen_typescript_type_definitions()?;
...
#[named]
pub fn gen_json_schema() -> Result<(), CmdError> {
    log_fn_name!(auto);
...
#[named]
pub fn gen_typescript_type_definitions() -> Result<(), CmdError> {
    log_fn_name!(auto);
