use crate::server::{globals::ServerGlobals, http::api::ApiResult};
use actix_web::{HttpRequest, get, put, web};
use function_name::named;
use scoretracker::{data::scoreboard::performance::AnyPerformanceDetails, info, log_fn_name, util::uuid::UuidString};
