...
export interface __ {
  __match_details: BandHeroMatchDetails;
  __performance_details: BandHeroPerformanceDetails;
}
export interface BandHeroMatchDetails {
  /**
...
export interface BandHeroPerformanceDetails {
  /**
   * Played instrument.
   */
