...
export interface __ {
  __match_details: InFalsusMatchDetails;
  __performance_details: InFalsusPerformanceDetails;
}
export interface InFalsusMatchDetails {}
export interface InFalsusPerformanceDetails {
  results: Results;
}
